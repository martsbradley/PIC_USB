package com.mbradley.usb.early;
...
/* This is just the first example I wrote
 * wanted to keep it around for reference 
 *
 * It is single threaded so might be better
 * for debugging the device when things appear
